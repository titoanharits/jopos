      ...
      <div class="card-body">
        <div class="table-responsive">
          <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
            ...
            <div class="row">
              <div class="col-sm-1">
                <a href="{{route('createsupplier')}}" class="btn btn-lg btn-primary">Tambah</a>
              </div>
                ...
                <table class="table table-bordered dataTable" id="table" data-toggle="table" data-pagination="true" data-search="true" data-toolbar="#toolbar">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="{{route('editsupplier', $item )}}"
                        style="display: inline">
                        <button class="btn-circle btn-md btn-primary" style="width: 37px;">
                          <i class="fa fa-edit"></i>
                        </button>
                      </form>
                      <form action="{{route('deletesupplier', $item)}}" method="POST"
                      style="display: inline">
